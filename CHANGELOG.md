...
* Удалён мод Eureka! AirShips
* Удалён мод ValkyrienSkies
* Исправлены зависания в одиночной игре
* Исправлена анимация удара Тирвинга, Пылающего меча и Адского молота
* Добавлены главы Технологии I и Магия I в стартовый набор квестов
* Добавлено постепенное открытие модификаций с прохождением квестовой системы (как сделано на официальных серверах сборки)
* Исправлено ломание блоков из мода BornInChaos 
* Исправлено ломание блоков из мода Corn's Delight
* Исправлено ломание блоков из мода Twilight Delight
* Добавлен рецепт создания ванильных инструментов из Tetra инструментов при помощи Гаечного ключа на Столе Кузнеца
* Добавлен рецепт получения стеклянных осколков при помощи крушителя Create
* Возвращены рецепты создания инструментов мода Botania
* Обновлённый рецепт создания верстака
* Убран рецепт Кремниевого меча
* Перенастроены таблицы лута
* Обновлены настройки спавна мобов в зависимости от прогресса в квестовой системе
* Ифриты теперь спавнятся в биоме Магмовые Поля
* Визер-скелеты спавнятся в Незерских Катакомбах
* Убран дроп с мобов, появившихся из спавнера
* Верёвки из мода AdditionalAdditions и Supplementaries заменены на верёвки из мода FarmersDelight
* Гаечный ключ из мода AdditionalAdditions заменён на гаечный ключ из мода Supplementaries
* Добавлен согревающий эффект от напитков мода Farmer's Respite
* Добавлена кнопка Онлайн-карты в меню паузы для серверов сборки
* Обновлены кнопки в меню игры
* Обновлено описание серверов в меню Мультиплеера
* Обновлены текстуры мода Botania
* Обновлены текстуры сундуков Lootr
* Обновлена текстура бара здоровья Червя Пустоты
* Обновлено 10 модификаций
